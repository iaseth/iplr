...
export function MatchCard ({match, naked=false}) {
	...
	return (
		<div className="MatchCard select-none">
			...
			<Link to={match.getLink()} className="block sm:mx-2 mb-6 md:mb-12 px-4 py-5 sm:w-80 bg-slate-900 text-slate-200 border-2 border-slate-600 rounded cursor-pointer hover:bg-slate-800"
				style={match.bdStyle}>
				<div className="flex">
